...
CREATE INDEX IF NOT EXISTS idx_crypto_id ON public.fact_crypto_markets (crypto_id);
CREATE INDEX IF NOT EXISTS idx_symbol ON public.fact_crypto_markets (symbol);
...
CREATE TABLE IF NOT EXISTS public.dim_exchange_rates (
    ...
    time_next_update_utc TIMESTAMP,
